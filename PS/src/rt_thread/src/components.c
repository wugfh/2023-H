...
static int rti_2_end(void)
{
    return 0;
}
INIT_PREV_EXPORT(rti_2_end);

static int rti_3_end(void)
{
    return 0;
}
INIT_DEVICE_EXPORT(rti_3_end);

static int rti_4_end(void)
{
    return 0;
}
INIT_COMPONENT_EXPORT(rti_4_end);

static int rti_5_end(void)
{
    return 0;
}
INIT_ENV_EXPORT(rti_5_end);

static int rti_6_end(void)
{
    return 0;
}
INIT_APP_EXPORT(rti_6_end);
